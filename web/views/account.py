...
def my(request):
    # obj = models.UserInfo.objects.create(username='test', password='123', email='123@qq.com', mobile_phone='123456')
    # obj = models.UserInfo.objects.filter(username="test")
    # print(obj.first())
    user_object = models.UserInfo.objects.filter(Q(email="123@qq.com") | Q(mobile_phone="123456")).filter(
        password=123).first()
    print(user_object)
